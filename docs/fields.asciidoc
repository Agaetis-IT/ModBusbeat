...
--
This document describes the fields that are exported by Modbusbeat. They are
...
Modbus register type to read like Holding, Input, Discret or Coil
...
Modbus address to read like 101 or 0x65
